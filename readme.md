...
- [ ] **共建共享的面经数据库**：天下苦面经久矣，零散、没答案、平台信息茧房。我们会打通企业到求职者的数据网络。
- [ ] **题库文档溯源、分层整理**：现存的八股大都不忠于文档，这有悖于行业标准，也不利于求职者掌握系统的知识。除了文档溯源，还会进行分层整理，八股本身、八股的理解和常见问题、八股的实际应用、如何引导面试官到自己熟悉的领域。
