...
| **📚面经数据库** | [将面室中的题库导入本地Anki](doc/hub/教程：1、anki配置.md)                            |
...
您可以在 [www.ai.pinkprisma.com](https://www.pinkprisma.com) 上在线免费使用魔历。

> 岗位爬取与匹配、题库导入与anki集成、项目亮点实现agent，目前只能在本地部署使用，其它所有功能都可以在线使用。
