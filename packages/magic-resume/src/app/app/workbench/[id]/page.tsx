		...
		>
			<TooltipProvider>
				<Tooltip>
					...
					<TooltipContent>
						<p className="text-xs">{sidePanelCollapsed ? '展开侧边栏' : '收起侧边栏'}</p>
					</TooltipContent>
				</Tooltip>
			</TooltipProvider>
			...
			<TooltipProvider>
				<Tooltip>
					...
					<TooltipContent>
						<p className="text-xs">{editPanelCollapsed ? '展开编辑面板' : '收起编辑面板'}</p>
					</TooltipContent>
				</Tooltip>
			</TooltipProvider>
			...
			<TooltipProvider>
				<Tooltip>
					...
					<TooltipContent>
						<p className="text-xs">{previewPanelCollapsed ? '展开预览面板' : '收起预览面板'}</p>
					</TooltipContent>
				</Tooltip>
			</TooltipProvider>
		</div>
					...
					{!sidePanelCollapsed && (
						<>
							<ResizablePanel
								...
								minSize={20}
								className={cn('dark:bg-neutral-900 dark:border-r dark:border-neutral-800')}
							>
