...
const Home: React.FC = () => {
	...
	const features = [
		...
		},
		{
			...
			title: '定制简历与岗位匹配',
			description:
				'告别海投无门！doro 会根据具体岗位要求，为您量身定制简历。我们还内置招聘数据爬取功能，并通过智能模型为您精准匹配最合适的岗位。'
		},
		{
			emoji: '🔑',
			title: '项目亮点实现',
			description: '通过AI Agent技术,和 doro 协同进行需求分析、开发计划、代码实现，将项目亮点落地'
		},
		{
			emoji: '🗺️',
			title: '面向Offer学习',
			description: '为您规划清晰的求职学习路线等。(coming soon)'
		}
	];
