...
export const ProjectPolishedSchema =
  SchemaFactory.createForClass(ProjectPolished);

ProjectPolishedSchema.index({ 'userInfo.userId': 1, status: 1 });

ProjectPolishedSchema.pre(
  'save',
  async function (this: ProjectPolishedDocument) {
