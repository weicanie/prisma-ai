					...
					<div class="mb-6">
						...
						<div class="mb-4">
							...
							<div class="grid grid-cols-1 md:grid-cols-2 gap-6 pl-4 border-l-2 border-blue-100">
								...
								<el-form-item label="Project Code TopK">
									<el-input-number v-model="form.agent.topK.plan.projectCode" :min="1" :max="50" />
								</el-form-item>
							</div>
						</div>
						...
						<div class="mb-4">
							<span class="text-sm font-semibold text-gray-700 block mb-2"
								>Replan (重规划阶段)</span
							>
							<div class="grid grid-cols-1 md:grid-cols-2 gap-6 pl-4 border-l-2 border-orange-100">
								<el-form-item label="Knowledge TopK">
									<el-input-number v-model="form.agent.topK.replan.knowledge" :min="1" :max="50" />
								</el-form-item>
								<el-form-item label="Project Code TopK">
									<el-input-number
